...
static const char qt_meta_stringdata_SupernovaeDialog[] = {
    "SupernovaeDialog\0\0retranslate()\0"
    "refreshUpdateValues()\0days\0"
    "setUpdateValues(int)\0checkState\0"
    "setUpdatesEnabled(int)\0state\0"
    "updateStateReceiver(Supernovae::UpdateState)\0"
...
const QMetaObjectExtraData SupernovaeDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SupernovaeDialog::staticMetaObject = {
    { &StelDialog::staticMetaObject, qt_meta_stringdata_SupernovaeDialog,
      qt_meta_data_SupernovaeDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SupernovaeDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SupernovaeDialog))
