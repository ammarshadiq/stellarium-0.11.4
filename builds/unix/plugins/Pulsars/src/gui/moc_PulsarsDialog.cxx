...
**
** Created: Sat Apr 20 14:30:12 2013
...
static const char qt_meta_stringdata_PulsarsDialog[] = {
    "PulsarsDialog\0\0retranslate()\0"
    "refreshUpdateValues()\0days\0"
    "setUpdateValues(int)\0checkState\0"
    "setUpdatesEnabled(int)\0"
    "setDistributionEnabled(int)\0state\0"
    "updateStateReceiver(Pulsars::UpdateState)\0"
...
void PulsarsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->updateStateReceiver((*reinterpret_cast< Pulsars::UpdateState(*)>(_a[1]))); break;
...
const QMetaObjectExtraData PulsarsDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PulsarsDialog::staticMetaObject = {
    { &StelDialog::staticMetaObject, qt_meta_stringdata_PulsarsDialog,
      qt_meta_data_PulsarsDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PulsarsDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PulsarsDialog))
