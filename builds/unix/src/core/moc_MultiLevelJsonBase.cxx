...
static const char qt_meta_stringdata_MultiLevelJsonBase[] = {
    "MultiLevelJsonBase\0\0downloadFinished()\0"
    "jsonLoadFinished()\0"
};
...
const QMetaObjectExtraData MultiLevelJsonBase::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MultiLevelJsonBase::staticMetaObject = {
    { &StelSkyLayer::staticMetaObject, qt_meta_stringdata_MultiLevelJsonBase,
      qt_meta_data_MultiLevelJsonBase, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MultiLevelJsonBase::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MultiLevelJsonBase))
