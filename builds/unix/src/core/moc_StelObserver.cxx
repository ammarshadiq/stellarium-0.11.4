...
static const char qt_meta_stringdata_StelObserver[] = {
    "StelObserver\0"
};
...
const QMetaObjectExtraData StelObserver::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StelObserver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StelObserver,
      qt_meta_data_StelObserver, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StelObserver::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelObserver))
