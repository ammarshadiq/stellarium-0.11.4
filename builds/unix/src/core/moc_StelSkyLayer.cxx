...
static const char qt_meta_stringdata_StelSkyLayer[] = {
    "StelSkyLayer\0\0b\0loadingStateChanged(bool)\0"
...
const QMetaObjectExtraData StelSkyLayer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StelSkyLayer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StelSkyLayer,
      qt_meta_data_StelSkyLayer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StelSkyLayer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelSkyLayer))
