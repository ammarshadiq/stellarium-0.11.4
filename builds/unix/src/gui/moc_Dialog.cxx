...
static const char qt_meta_stringdata_BarFrame[] = {
    "BarFrame\0"
};
...
const QMetaObjectExtraData BarFrame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BarFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_BarFrame,
      qt_meta_data_BarFrame, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BarFrame::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BarFrame))
...
static const char qt_meta_stringdata_ResizeFrame[] = {
    "ResizeFrame\0"
};
...
const QMetaObjectExtraData ResizeFrame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ResizeFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ResizeFrame,
      qt_meta_data_ResizeFrame, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ResizeFrame::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ResizeFrame))
