...
static const char qt_meta_stringdata_DateTimeDialog[] = {
    "DateTimeDialog\0\0retranslate()\0newJd\0"
    "setDateTime(double)\0close()\0ny\0"
    "yearChanged(int)\0nm\0monthChanged(int)\0"
    "nd\0dayChanged(int)\0nh\0hourChanged(int)\0"
    "minuteChanged(int)\0ns\0secondChanged(int)\0"
};
...
const QMetaObject DateTimeDialog::staticMetaObject = {
    { &StelDialog::staticMetaObject, qt_meta_stringdata_DateTimeDialog,
