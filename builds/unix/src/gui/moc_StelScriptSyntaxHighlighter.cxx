...
static const char qt_meta_stringdata_StelScriptSyntaxHighlighter[] = {
    "StelScriptSyntaxHighlighter\0"
};
...
const QMetaObjectExtraData StelScriptSyntaxHighlighter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StelScriptSyntaxHighlighter::staticMetaObject = {
    { &QSyntaxHighlighter::staticMetaObject, qt_meta_stringdata_StelScriptSyntaxHighlighter,
      qt_meta_data_StelScriptSyntaxHighlighter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StelScriptSyntaxHighlighter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelScriptSyntaxHighlighter))
