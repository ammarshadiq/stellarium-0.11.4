...
static const char qt_meta_stringdata_StelDialog[] = {
    "StelDialog\0\0visibleChanged(bool)\0"
    "retranslate()\0setVisible(bool)\0close()\0"
};
...
const QMetaObjectExtraData StelDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StelDialog::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StelDialog,
      qt_meta_data_StelDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StelDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StelDialog))
