...
**
** Created: Sun Oct 28 11:04:52 2012
...
public:
    ...
    void setupUi(QWidget *supernovaeDialog)
    {
        if (supernovaeDialog->objectName().isEmpty())
            supernovaeDialog->setObjectName(QString::fromUtf8("supernovaeDialog"));
    ...
    {
        supernovaeDialog->setWindowTitle(QApplication::translate("supernovaeDialog", "Historical Supernovae Configuration", 0, QApplication::UnicodeUTF8));
        stelWindowTitle->setText(QApplication::translate("supernovaeDialog", "Historical Supernovae Plug-in Configuration", 0, QApplication::UnicodeUTF8));
        closeStelWindow->setText(QString());
        updatesGroup->setTitle(QApplication::translate("supernovaeDialog", "Update catalog from Internet", 0, QApplication::UnicodeUTF8));
        internetUpdatesCheckbox->setText(QApplication::translate("supernovaeDialog", "Update from Internet sources", 0, QApplication::UnicodeUTF8));
        lastUpdateLabel->setText(QApplication::translate("supernovaeDialog", "Last update:", 0, QApplication::UnicodeUTF8));
        updateFrequencyLabel->setText(QApplication::translate("supernovaeDialog", "Update frequency (days):", 0, QApplication::UnicodeUTF8));
        nextUpdateLabel->setText(QApplication::translate("supernovaeDialog", "[next update info]", 0, QApplication::UnicodeUTF8));
        updateButton->setText(QApplication::translate("supernovaeDialog", "Update now", 0, QApplication::UnicodeUTF8));
        restoreDefaultsButton->setText(QApplication::translate("supernovaeDialog", "Restore default settings", 0, QApplication::UnicodeUTF8));
        saveSettingsButton->setText(QApplication::translate("supernovaeDialog", "Save settings as default", 0, QApplication::UnicodeUTF8));
        tabs->setTabText(tabs->indexOf(settingsTab), QApplication::translate("supernovaeDialog", "Settings", 0, QApplication::UnicodeUTF8));
        tabs->setTabText(tabs->indexOf(aboutTab), QApplication::translate("supernovaeDialog", "About", "tab in plugin windows", QApplication::UnicodeUTF8));
    } // retranslateUi
